...
// #define MATRIX_COL_PINS { C6, D4, D6, B4, B5, B6, D7, B0, B1, B2, B3 } // Left
// #define UNUSED_PINS { B0, B1, B2, B3 }

#define MATRIX_ROW_PINS { F0, F1, F4, F5, F6, F7 } // Right
#define MATRIX_COL_PINS { B0, B1, B7, B3, C6, C7, D4, D7, B4, B5, B6 } // Right
